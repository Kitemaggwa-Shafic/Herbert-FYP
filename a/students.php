  ...
  <body>
	    	...
	    	<div class="row">
					<div class="col-md-12">
						<div class="search-wrap-1 ftco-animate p-4" style = "border: solid white 4px;">
							...
							<form action="approve_research.php" class="search-property-1" method="POST">
		        		<div class="row">
    ...
    <section>
      ...
      <table class="table" border="1" cellpadding="2" cellspacing="1" width="0%" align="center">
          ...
          <th>Research Date Registered</th>
          <th>Student Research Topic Name</th>
      ...
      $sno =0;
          ...
          WHERE research_approved = 'FALSE'  
          ORDER BY students.student_name ASC ");
            while($all_students = $fetch_student->fetch_assoc()){

        //       echo '<td>
        // <a href="../student/Repositories/'.$all_students['repositoryID'].'/.index.php" 
        // style = "color: blue; font-weight: bold;">'.$all_students['title'].' Click to Download</a>
        // </td>';
              echo '<td>
        <a href="../student/upload/'.$all_students['project'].'" 
        style = "color: blue; font-weight: bold;">Click to Download</a>
        </td>';
        ...
        <td style="width:20%">
          <a style="color:#000fff"
          href="approve_research.php?recordid=<?php echo $all_students['recordid']; ?>" >
          <img src="../images/warn.png"  width="45" height="35"/> Approve This Research</a>
        </td>
        <!-- <td><a href="<?php echo $all_students['project']; ?>">Click 2 Download</a></td> -->
