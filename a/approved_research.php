                        ...
                        <tr>
                            <td style = "width: 80%;">
                                <div class="form-group" style = "margin: 0;">
                                    <input type="text" class="form-control" name = "searchquery" placeholder="Search Approved Students By Student Name" style = "border-bottom: solid blue 5px;" required>
                                </div>
                            </td>
                            <td style = "width: 20%;">
                                <div class="form-group" style = "margin: 0;">
      ...
      <div class="container">
        <div class="row pt-md-5">
          <div class="col-md-12 heading-section text-left ftco-animate">
              <p style = "font-size: 20px; font-weight: bold; color: blue;">Approved Research Projects</p>
